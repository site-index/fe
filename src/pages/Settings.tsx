        ...
        <div className="space-y-6">
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-sm space-y-4">
                ...
                <p className="text-xs text-muted-foreground">
                    Con proxy de Vite, la base es{' '}
                    <span className="font-mono">/api</span> (ver{' '}
                    <span className="font-mono">vite.config.ts</span>). Podés
                    fijar <span className="font-mono">VITE_API_URL</span> para
                    apuntar al backend sin proxy.
                </p>
                ...
                <div className="space-y-2 max-w-md">
                    ...
                    <Input
                        ...
                        onBlur={() =>
                            setStudioSlug(slugDraft.trim().toLowerCase())
                        }
                        placeholder="ej. acme"
                        className="font-mono"
                    />
            ...
            <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-lg border border-border bg-card p-5 shadow-sm space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                        Multi-moneda con tratamiento diferenciado de USD
                        oficial/blue es un requerimiento del producto.
                    </p>
                </div>
